...
const createPages = (cursor, part) => {
  ...
  elemA.href = "/admin/formularios/resueltos/referencias?cursor=" + JSON.stringify(cursor) + "&part=" + part + "&dir=prev"
  ...
  elemA = document.createElement('a')
  elemA.classList.add('nav-link')
  elemA.href = "/admin/formularios/resueltos/referencias?cursor=" + JSON.stringify(cursor) + "&part=" + part + "&dir=next"
