...
// incialializar
document.getElementById('add').setAttribute('action', `/admin/formularios/asignados/referencias/insert?part=${getCookie('filtra')}`)
document.getElementById('volver').setAttribute('href', `/admin/formularios/asignados/referencias/${formulario.IDFORM}?part=${getCookie('filtra')}`)
