...
const estados = datos.estadosDocumento
...
const createPages = () => {
  ...
  elemA.href = "/admin/formularios/asignados?cursor=" + JSON.stringify(cursor) + "&part=" + part + "&dir=prev"
  ...
  elemA = document.createElement('a')
  elemA.classList.add('nav-link')
  elemA.href = "/admin/formularios/asignados?cursor=" + JSON.stringify(cursor) + "&part=" + part + "&dir=next"
