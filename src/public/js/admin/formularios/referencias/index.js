...
elemNew.setAttribute('href', `/admin/formularios/referencias/add/${formulario.IDFORM}?part=${getCookie('filtro')}`)
const elemNewResp = document.getElementById('resp');
elemNewResp.setAttribute('href', `/admin/formularios/referencias/add/${formulario.IDFORM}?part=${getCookie('filtro')}`)
...
elemVol.setAttribute('href', `/admin/formularios/asignados?part=${getCookie('filtro')}`)
