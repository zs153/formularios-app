...
const createPages = () => {
  ...
  elemA.href = "/user/formularios/resueltos/referencias?cursor=" + JSON.stringify(cursor) + "&part=" + part + "&dir=prev"
  ...
  elemA = document.createElement('a')
  elemA.classList.add('nav-link')
  elemA.href = "/user/formularios/resueltos/referencias?cursor=" + JSON.stringify(cursor) + "&part=" + part + "&dir=next"
